...
export default function Button({
  ...
  return (
    <button
      className={cn(
        'inline-flex items-center justify-center gap-2 rounded-xl font-medium transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold-300/40 disabled:opacity-60 disabled:pointer-events-none',
