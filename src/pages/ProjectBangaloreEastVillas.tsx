    ...
    <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6 sm:py-20">
      <div className="grid gap-10 lg:grid-cols-12">
        <div className="lg:col-span-7">
          ...
          <Reveal delay={0.06}>
            <div className="mt-8 grid gap-4 rounded-3xl border border-ink-950/10 bg-white/80 p-6 shadow-soft sm:grid-cols-3">
              <div className="rounded-2xl border border-ink-950/10 bg-canvas-100 p-5">
        ...
        <div className="lg:col-span-5">
          <Reveal delay={0.08}>
            <div className="rounded-3xl border border-ink-950/10 bg-gradient-to-br from-white/80 to-canvas-100 p-6 shadow-soft">
              ...
              <div className="mt-6 rounded-2xl border border-ink-950/10 bg-canvas-100 p-5">
